...
const LoginForm: React.FC<{}> = () => {
  return getCookie('token') !== '' ? <div>
    ...
    <button className="kiwi-menu-button" style={buttonStyle} onClick={_ => {
      removeCookie('token')
      ...
      <button className="kiwi-menu-button" style={buttonStyle} onClick={async _ => {
        let accountName = (document.getElementById('kiwi-login-name') as HTMLInputElement).value
        // post the request
